---
name: "source-command-generate-meta-data"
description: "Generate and update structured metadata files (.{filename}.meta.md and .dir.meta.md) for files and directories. Uses sub-agents for parallel prep. Computes MD5 checksums, extracts class/function layouts as Mermaid diagrams, maps incoming/outgoing links, and flags TODOs/issues."
---

# source-command-generate-meta-data

Use this skill when the user asks to run the migrated source command `generate-meta-data`.
...
Note: put checksum details in a `---`-delimited block for YAML extraction.
