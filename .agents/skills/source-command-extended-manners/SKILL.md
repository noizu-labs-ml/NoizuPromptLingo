---
name: "source-command-extended-manners"
...
# source-command-extended-manners

Use this skill when the user asks to run the migrated source command `extended-manners`.
