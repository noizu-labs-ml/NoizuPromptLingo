---
name: "source-command-manners"
description: "Reiterates output conventions from AGENTS.md. Use when Codex is skipping required sections or needs a format reset. Equivalent to a strong :MYM reminder."
---

# source-command-manners

Use this skill when the user asks to run the migrated source command `manners`.
