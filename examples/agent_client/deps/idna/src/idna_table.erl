...
lookup(42954) -> 'PVALID';
lookup(42957) -> 'PVALID';
lookup(42958) -> 'DISALLOWED';
lookup(42959) -> 'PVALID';
lookup(42960) -> 'DISALLOWED';
lookup(42961) -> 'PVALID';
lookup(42962) -> 'DISALLOWED';
lookup(42963) -> 'PVALID';
lookup(42964) -> 'DISALLOWED';
lookup(42965) -> 'PVALID';
lookup(42966) -> 'DISALLOWED';
lookup(42967) -> 'PVALID';
lookup(42968) -> 'DISALLOWED';
lookup(42969) -> 'PVALID';
lookup(42970) -> 'DISALLOWED';
lookup(42971) -> 'PVALID';
lookup(42972) -> 'DISALLOWED';
lookup(42993) -> 'PVALID';
lookup(43052) -> 'PVALID';
lookup(43259) -> 'PVALID';
...
lookup(66939) -> 'UNASSIGNED';
lookup(66955) -> 'UNASSIGNED';
lookup(66963) -> 'UNASSIGNED';
lookup(66966) -> 'UNASSIGNED';
lookup(66978) -> 'UNASSIGNED';
lookup(66994) -> 'UNASSIGNED';
lookup(67002) -> 'UNASSIGNED';
lookup(67456) -> 'PVALID';
lookup(67462) -> 'UNASSIGNED';
lookup(67505) -> 'UNASSIGNED';
lookup(67592) -> 'PVALID';
...
lookup(70480) -> 'PVALID';
lookup(70487) -> 'PVALID';
lookup(70538) -> 'UNASSIGNED';
lookup(70539) -> 'PVALID';
lookup(70542) -> 'PVALID';
lookup(70543) -> 'UNASSIGNED';
lookup(70582) -> 'UNASSIGNED';
lookup(70593) -> 'UNASSIGNED';
lookup(70594) -> 'PVALID';
lookup(70597) -> 'PVALID';
lookup(70598) -> 'UNASSIGNED';
lookup(70603) -> 'UNASSIGNED';
lookup(70614) -> 'UNASSIGNED';
lookup(70748) -> 'UNASSIGNED';
lookup(70749) -> 'DISALLOWED';
lookup(70854) -> 'DISALLOWED';
lookup(70855) -> 'PVALID';
lookup(71236) -> 'PVALID';
lookup(71353) -> 'DISALLOWED';
...
lookup(123023) -> 'PVALID';
lookup(123214) -> 'PVALID';
lookup(123215) -> 'DISALLOWED';
lookup(123647) -> 'DISALLOWED';
lookup(124415) -> 'DISALLOWED';
lookup(124639) -> 'UNASSIGNED';
lookup(124903) -> 'UNASSIGNED';
lookup(124908) -> 'UNASSIGNED';
lookup(124911) -> 'UNASSIGNED';
lookup(124927) -> 'UNASSIGNED';
...
lookup(129008) -> 'DISALLOWED';
lookup(129735) -> 'UNASSIGNED';
lookup(129736) -> 'DISALLOWED';
...
lookup(CP) when 1563 =< CP, CP =< 1567 -> 'DISALLOWED';
...
lookup(CP) when 2155 =< CP, CP =< 2159 -> 'UNASSIGNED';
lookup(CP) when 2160 =< CP, CP =< 2183 -> 'PVALID';
lookup(CP) when 2185 =< CP, CP =< 2191 -> 'PVALID';
lookup(CP) when 2192 =< CP, CP =< 2193 -> 'DISALLOWED';
lookup(CP) when 2194 =< CP, CP =< 2198 -> 'UNASSIGNED';
lookup(CP) when 2199 =< CP, CP =< 2273 -> 'PVALID';
...
lookup(CP) when 3130 =< CP, CP =< 3131 -> 'UNASSIGNED';
lookup(CP) when 3132 =< CP, CP =< 3140 -> 'PVALID';
...
lookup(CP) when 3164 =< CP, CP =< 3165 -> 'PVALID';
lookup(CP) when 3166 =< CP, CP =< 3167 -> 'UNASSIGNED';
...
lookup(CP) when 3287 =< CP, CP =< 3291 -> 'UNASSIGNED';
lookup(CP) when 3292 =< CP, CP =< 3294 -> 'PVALID';
lookup(CP) when 3296 =< CP, CP =< 3299 -> 'PVALID';
lookup(CP) when 3300 =< CP, CP =< 3301 -> 'UNASSIGNED';
lookup(CP) when 3302 =< CP, CP =< 3311 -> 'PVALID';
lookup(CP) when 3313 =< CP, CP =< 3315 -> 'PVALID';
lookup(CP) when 3316 =< CP, CP =< 3327 -> 'UNASSIGNED';
...
lookup(CP) when 3784 =< CP, CP =< 3790 -> 'PVALID';
...
lookup(CP) when 5888 =< CP, CP =< 5909 -> 'PVALID';
lookup(CP) when 5910 =< CP, CP =< 5918 -> 'UNASSIGNED';
lookup(CP) when 5919 =< CP, CP =< 5940 -> 'PVALID';
...
lookup(CP) when 6144 =< CP, CP =< 6159 -> 'DISALLOWED';
...
lookup(CP) when 6847 =< CP, CP =< 6877 -> 'PVALID';
lookup(CP) when 6878 =< CP, CP =< 6879 -> 'UNASSIGNED';
lookup(CP) when 6880 =< CP, CP =< 6891 -> 'PVALID';
lookup(CP) when 6892 =< CP, CP =< 6911 -> 'UNASSIGNED';
lookup(CP) when 6912 =< CP, CP =< 6988 -> 'PVALID';
lookup(CP) when 6990 =< CP, CP =< 6991 -> 'DISALLOWED';
lookup(CP) when 6992 =< CP, CP =< 7001 -> 'PVALID';
lookup(CP) when 7002 =< CP, CP =< 7018 -> 'DISALLOWED';
lookup(CP) when 7019 =< CP, CP =< 7027 -> 'PVALID';
lookup(CP) when 7028 =< CP, CP =< 7039 -> 'DISALLOWED';
...
lookup(CP) when 7294 =< CP, CP =< 7305 -> 'DISALLOWED';
lookup(CP) when 7307 =< CP, CP =< 7311 -> 'UNASSIGNED';
...
lookup(CP) when 7616 =< CP, CP =< 7679 -> 'PVALID';
...
lookup(CP) when 8352 =< CP, CP =< 8385 -> 'DISALLOWED';
lookup(CP) when 8386 =< CP, CP =< 8399 -> 'UNASSIGNED';
...
lookup(CP) when 8592 =< CP, CP =< 9257 -> 'DISALLOWED';
lookup(CP) when 9258 =< CP, CP =< 9279 -> 'UNASSIGNED';
...
lookup(CP) when 11126 =< CP, CP =< 11311 -> 'DISALLOWED';
lookup(CP) when 11312 =< CP, CP =< 11359 -> 'PVALID';
...
lookup(CP) when 11824 =< CP, CP =< 11869 -> 'DISALLOWED';
lookup(CP) when 11870 =< CP, CP =< 11903 -> 'UNASSIGNED';
...
lookup(CP) when 12272 =< CP, CP =< 12292 -> 'DISALLOWED';
...
lookup(CP) when 12736 =< CP, CP =< 12773 -> 'DISALLOWED';
lookup(CP) when 12774 =< CP, CP =< 12782 -> 'UNASSIGNED';
...
lookup(CP) when 19968 =< CP, CP =< 42124 -> 'PVALID';
...
lookup(CP) when 42955 =< CP, CP =< 42956 -> 'DISALLOWED';
lookup(CP) when 42973 =< CP, CP =< 42992 -> 'UNASSIGNED';
lookup(CP) when 42994 =< CP, CP =< 42997 -> 'DISALLOWED';
...
lookup(CP) when 64326 =< CP, CP =< 65049 -> 'DISALLOWED';
...
lookup(CP) when 66927 =< CP, CP =< 66938 -> 'DISALLOWED';
lookup(CP) when 66940 =< CP, CP =< 66954 -> 'DISALLOWED';
lookup(CP) when 66956 =< CP, CP =< 66962 -> 'DISALLOWED';
lookup(CP) when 66964 =< CP, CP =< 66965 -> 'DISALLOWED';
lookup(CP) when 66967 =< CP, CP =< 66977 -> 'PVALID';
lookup(CP) when 66979 =< CP, CP =< 66993 -> 'PVALID';
lookup(CP) when 66995 =< CP, CP =< 67001 -> 'PVALID';
lookup(CP) when 67003 =< CP, CP =< 67004 -> 'PVALID';
lookup(CP) when 67005 =< CP, CP =< 67007 -> 'UNASSIGNED';
lookup(CP) when 67008 =< CP, CP =< 67059 -> 'PVALID';
lookup(CP) when 67060 =< CP, CP =< 67071 -> 'UNASSIGNED';
...
lookup(CP) when 67432 =< CP, CP =< 67455 -> 'UNASSIGNED';
lookup(CP) when 67457 =< CP, CP =< 67461 -> 'DISALLOWED';
lookup(CP) when 67463 =< CP, CP =< 67504 -> 'DISALLOWED';
lookup(CP) when 67506 =< CP, CP =< 67514 -> 'DISALLOWED';
lookup(CP) when 67515 =< CP, CP =< 67583 -> 'UNASSIGNED';
...
lookup(CP) when 67904 =< CP, CP =< 67929 -> 'PVALID';
lookup(CP) when 67930 =< CP, CP =< 67967 -> 'UNASSIGNED';
...
lookup(CP) when 68922 =< CP, CP =< 68927 -> 'UNASSIGNED';
lookup(CP) when 68928 =< CP, CP =< 68943 -> 'PVALID';
lookup(CP) when 68944 =< CP, CP =< 68965 -> 'DISALLOWED';
lookup(CP) when 68966 =< CP, CP =< 68968 -> 'UNASSIGNED';
lookup(CP) when 68969 =< CP, CP =< 68973 -> 'PVALID';
lookup(CP) when 68975 =< CP, CP =< 68997 -> 'PVALID';
lookup(CP) when 68998 =< CP, CP =< 69005 -> 'UNASSIGNED';
lookup(CP) when 69006 =< CP, CP =< 69007 -> 'DISALLOWED';
lookup(CP) when 69008 =< CP, CP =< 69215 -> 'UNASSIGNED';
...
lookup(CP) when 69298 =< CP, CP =< 69313 -> 'UNASSIGNED';
lookup(CP) when 69314 =< CP, CP =< 69319 -> 'PVALID';
lookup(CP) when 69320 =< CP, CP =< 69327 -> 'UNASSIGNED';
lookup(CP) when 69328 =< CP, CP =< 69336 -> 'DISALLOWED';
lookup(CP) when 69337 =< CP, CP =< 69369 -> 'UNASSIGNED';
lookup(CP) when 69370 =< CP, CP =< 69404 -> 'PVALID';
...
lookup(CP) when 69466 =< CP, CP =< 69487 -> 'UNASSIGNED';
lookup(CP) when 69488 =< CP, CP =< 69509 -> 'PVALID';
lookup(CP) when 69510 =< CP, CP =< 69513 -> 'DISALLOWED';
lookup(CP) when 69514 =< CP, CP =< 69551 -> 'UNASSIGNED';
...
lookup(CP) when 69734 =< CP, CP =< 69749 -> 'PVALID';
lookup(CP) when 69750 =< CP, CP =< 69758 -> 'UNASSIGNED';
lookup(CP) when 69759 =< CP, CP =< 69818 -> 'PVALID';
lookup(CP) when 69819 =< CP, CP =< 69825 -> 'DISALLOWED';
lookup(CP) when 69827 =< CP, CP =< 69836 -> 'UNASSIGNED';
...
lookup(CP) when 70206 =< CP, CP =< 70209 -> 'PVALID';
lookup(CP) when 70210 =< CP, CP =< 70271 -> 'UNASSIGNED';
...
lookup(CP) when 70517 =< CP, CP =< 70527 -> 'UNASSIGNED';
lookup(CP) when 70528 =< CP, CP =< 70537 -> 'PVALID';
lookup(CP) when 70540 =< CP, CP =< 70541 -> 'UNASSIGNED';
lookup(CP) when 70544 =< CP, CP =< 70581 -> 'PVALID';
lookup(CP) when 70583 =< CP, CP =< 70592 -> 'PVALID';
lookup(CP) when 70595 =< CP, CP =< 70596 -> 'UNASSIGNED';
lookup(CP) when 70599 =< CP, CP =< 70602 -> 'PVALID';
lookup(CP) when 70604 =< CP, CP =< 70611 -> 'PVALID';
lookup(CP) when 70612 =< CP, CP =< 70613 -> 'DISALLOWED';
lookup(CP) when 70615 =< CP, CP =< 70616 -> 'DISALLOWED';
lookup(CP) when 70617 =< CP, CP =< 70624 -> 'UNASSIGNED';
lookup(CP) when 70625 =< CP, CP =< 70626 -> 'PVALID';
lookup(CP) when 70627 =< CP, CP =< 70655 -> 'UNASSIGNED';
...
lookup(CP) when 71354 =< CP, CP =< 71359 -> 'UNASSIGNED';
lookup(CP) when 71360 =< CP, CP =< 71369 -> 'PVALID';
lookup(CP) when 71370 =< CP, CP =< 71375 -> 'UNASSIGNED';
lookup(CP) when 71376 =< CP, CP =< 71395 -> 'PVALID';
lookup(CP) when 71396 =< CP, CP =< 71423 -> 'UNASSIGNED';
...
lookup(CP) when 71488 =< CP, CP =< 71494 -> 'PVALID';
lookup(CP) when 71495 =< CP, CP =< 71679 -> 'UNASSIGNED';
...
lookup(CP) when 72355 =< CP, CP =< 72367 -> 'UNASSIGNED';
lookup(CP) when 72368 =< CP, CP =< 72440 -> 'PVALID';
lookup(CP) when 72441 =< CP, CP =< 72447 -> 'UNASSIGNED';
lookup(CP) when 72448 =< CP, CP =< 72457 -> 'DISALLOWED';
lookup(CP) when 72458 =< CP, CP =< 72543 -> 'UNASSIGNED';
lookup(CP) when 72544 =< CP, CP =< 72551 -> 'PVALID';
lookup(CP) when 72552 =< CP, CP =< 72639 -> 'UNASSIGNED';
lookup(CP) when 72640 =< CP, CP =< 72672 -> 'PVALID';
lookup(CP) when 72674 =< CP, CP =< 72687 -> 'UNASSIGNED';
lookup(CP) when 72688 =< CP, CP =< 72697 -> 'PVALID';
lookup(CP) when 72698 =< CP, CP =< 72703 -> 'UNASSIGNED';
...
lookup(CP) when 73130 =< CP, CP =< 73135 -> 'UNASSIGNED';
lookup(CP) when 73136 =< CP, CP =< 73179 -> 'PVALID';
lookup(CP) when 73180 =< CP, CP =< 73183 -> 'UNASSIGNED';
lookup(CP) when 73184 =< CP, CP =< 73193 -> 'PVALID';
lookup(CP) when 73194 =< CP, CP =< 73439 -> 'UNASSIGNED';
lookup(CP) when 73440 =< CP, CP =< 73462 -> 'PVALID';
lookup(CP) when 73463 =< CP, CP =< 73464 -> 'DISALLOWED';
lookup(CP) when 73465 =< CP, CP =< 73471 -> 'UNASSIGNED';
lookup(CP) when 73472 =< CP, CP =< 73488 -> 'PVALID';
lookup(CP) when 73490 =< CP, CP =< 73530 -> 'PVALID';
lookup(CP) when 73531 =< CP, CP =< 73533 -> 'UNASSIGNED';
lookup(CP) when 73534 =< CP, CP =< 73538 -> 'PVALID';
lookup(CP) when 73539 =< CP, CP =< 73551 -> 'DISALLOWED';
lookup(CP) when 73552 =< CP, CP =< 73562 -> 'PVALID';
lookup(CP) when 73563 =< CP, CP =< 73647 -> 'UNASSIGNED';
...
lookup(CP) when 75076 =< CP, CP =< 77711 -> 'UNASSIGNED';
lookup(CP) when 77712 =< CP, CP =< 77808 -> 'PVALID';
lookup(CP) when 77809 =< CP, CP =< 77810 -> 'DISALLOWED';
lookup(CP) when 77811 =< CP, CP =< 77823 -> 'UNASSIGNED';
lookup(CP) when 77824 =< CP, CP =< 78895 -> 'PVALID';
lookup(CP) when 78896 =< CP, CP =< 78911 -> 'DISALLOWED';
lookup(CP) when 78912 =< CP, CP =< 78933 -> 'PVALID';
lookup(CP) when 78934 =< CP, CP =< 78943 -> 'UNASSIGNED';
lookup(CP) when 78944 =< CP, CP =< 82938 -> 'PVALID';
lookup(CP) when 82939 =< CP, CP =< 82943 -> 'UNASSIGNED';
lookup(CP) when 82944 =< CP, CP =< 83526 -> 'PVALID';
lookup(CP) when 83527 =< CP, CP =< 90367 -> 'UNASSIGNED';
lookup(CP) when 90368 =< CP, CP =< 90425 -> 'PVALID';
lookup(CP) when 90426 =< CP, CP =< 92159 -> 'UNASSIGNED';
...
lookup(CP) when 92784 =< CP, CP =< 92862 -> 'PVALID';
lookup(CP) when 92864 =< CP, CP =< 92873 -> 'PVALID';
lookup(CP) when 92874 =< CP, CP =< 92879 -> 'UNASSIGNED';
...
lookup(CP) when 93072 =< CP, CP =< 93503 -> 'UNASSIGNED';
lookup(CP) when 93504 =< CP, CP =< 93548 -> 'PVALID';
lookup(CP) when 93549 =< CP, CP =< 93551 -> 'DISALLOWED';
lookup(CP) when 93552 =< CP, CP =< 93561 -> 'PVALID';
lookup(CP) when 93562 =< CP, CP =< 93759 -> 'UNASSIGNED';
...
lookup(CP) when 93851 =< CP, CP =< 93855 -> 'UNASSIGNED';
lookup(CP) when 93856 =< CP, CP =< 93880 -> 'DISALLOWED';
lookup(CP) when 93881 =< CP, CP =< 93882 -> 'UNASSIGNED';
lookup(CP) when 93883 =< CP, CP =< 93907 -> 'PVALID';
lookup(CP) when 93908 =< CP, CP =< 93951 -> 'UNASSIGNED';
...
lookup(CP) when 94192 =< CP, CP =< 94195 -> 'PVALID';
lookup(CP) when 94196 =< CP, CP =< 94198 -> 'DISALLOWED';
lookup(CP) when 94199 =< CP, CP =< 94207 -> 'UNASSIGNED';
lookup(CP) when 94208 =< CP, CP =< 101589 -> 'PVALID';
lookup(CP) when 101590 =< CP, CP =< 101630 -> 'UNASSIGNED';
lookup(CP) when 101631 =< CP, CP =< 101662 -> 'PVALID';
lookup(CP) when 101663 =< CP, CP =< 101759 -> 'UNASSIGNED';
lookup(CP) when 101760 =< CP, CP =< 101874 -> 'PVALID';
lookup(CP) when 101875 =< CP, CP =< 110575 -> 'UNASSIGNED';
lookup(CP) when 110576 =< CP, CP =< 110579 -> 'PVALID';
lookup(CP) when 110581 =< CP, CP =< 110587 -> 'PVALID';
lookup(CP) when 110589 =< CP, CP =< 110590 -> 'PVALID';
lookup(CP) when 110592 =< CP, CP =< 110882 -> 'PVALID';
lookup(CP) when 110883 =< CP, CP =< 110897 -> 'UNASSIGNED';
lookup(CP) when 110899 =< CP, CP =< 110927 -> 'UNASSIGNED';
lookup(CP) when 110928 =< CP, CP =< 110930 -> 'PVALID';
lookup(CP) when 110931 =< CP, CP =< 110932 -> 'UNASSIGNED';
lookup(CP) when 110934 =< CP, CP =< 110947 -> 'UNASSIGNED';
...
lookup(CP) when 113828 =< CP, CP =< 117759 -> 'UNASSIGNED';
lookup(CP) when 117760 =< CP, CP =< 117999 -> 'DISALLOWED';
lookup(CP) when 118000 =< CP, CP =< 118009 -> 'PVALID';
lookup(CP) when 118010 =< CP, CP =< 118012 -> 'DISALLOWED';
lookup(CP) when 118013 =< CP, CP =< 118015 -> 'UNASSIGNED';
lookup(CP) when 118016 =< CP, CP =< 118451 -> 'DISALLOWED';
lookup(CP) when 118452 =< CP, CP =< 118457 -> 'UNASSIGNED';
lookup(CP) when 118458 =< CP, CP =< 118480 -> 'DISALLOWED';
lookup(CP) when 118481 =< CP, CP =< 118495 -> 'UNASSIGNED';
lookup(CP) when 118496 =< CP, CP =< 118512 -> 'DISALLOWED';
lookup(CP) when 118513 =< CP, CP =< 118527 -> 'UNASSIGNED';
lookup(CP) when 118528 =< CP, CP =< 118573 -> 'PVALID';
lookup(CP) when 118574 =< CP, CP =< 118575 -> 'UNASSIGNED';
lookup(CP) when 118576 =< CP, CP =< 118598 -> 'PVALID';
lookup(CP) when 118599 =< CP, CP =< 118607 -> 'UNASSIGNED';
lookup(CP) when 118608 =< CP, CP =< 118723 -> 'DISALLOWED';
lookup(CP) when 118724 =< CP, CP =< 118783 -> 'UNASSIGNED';
...
lookup(CP) when 119081 =< CP, CP =< 119274 -> 'DISALLOWED';
lookup(CP) when 119275 =< CP, CP =< 119295 -> 'UNASSIGNED';
lookup(CP) when 119296 =< CP, CP =< 119365 -> 'DISALLOWED';
lookup(CP) when 119366 =< CP, CP =< 119487 -> 'UNASSIGNED';
lookup(CP) when 119488 =< CP, CP =< 119507 -> 'DISALLOWED';
lookup(CP) when 119508 =< CP, CP =< 119519 -> 'UNASSIGNED';
...
lookup(CP) when 121520 =< CP, CP =< 122623 -> 'UNASSIGNED';
lookup(CP) when 122624 =< CP, CP =< 122654 -> 'PVALID';
lookup(CP) when 122655 =< CP, CP =< 122660 -> 'UNASSIGNED';
lookup(CP) when 122661 =< CP, CP =< 122666 -> 'PVALID';
lookup(CP) when 122667 =< CP, CP =< 122879 -> 'UNASSIGNED';
...
lookup(CP) when 122923 =< CP, CP =< 122927 -> 'UNASSIGNED';
lookup(CP) when 122928 =< CP, CP =< 122989 -> 'DISALLOWED';
lookup(CP) when 122990 =< CP, CP =< 123022 -> 'UNASSIGNED';
lookup(CP) when 123024 =< CP, CP =< 123135 -> 'UNASSIGNED';
...
lookup(CP) when 123216 =< CP, CP =< 123535 -> 'UNASSIGNED';
lookup(CP) when 123536 =< CP, CP =< 123566 -> 'PVALID';
lookup(CP) when 123567 =< CP, CP =< 123583 -> 'UNASSIGNED';
lookup(CP) when 123584 =< CP, CP =< 123641 -> 'PVALID';
lookup(CP) when 123642 =< CP, CP =< 123646 -> 'UNASSIGNED';
lookup(CP) when 123648 =< CP, CP =< 124111 -> 'UNASSIGNED';
lookup(CP) when 124112 =< CP, CP =< 124153 -> 'PVALID';
lookup(CP) when 124154 =< CP, CP =< 124367 -> 'UNASSIGNED';
lookup(CP) when 124368 =< CP, CP =< 124410 -> 'PVALID';
lookup(CP) when 124411 =< CP, CP =< 124414 -> 'UNASSIGNED';
lookup(CP) when 124416 =< CP, CP =< 124607 -> 'UNASSIGNED';
lookup(CP) when 124608 =< CP, CP =< 124638 -> 'PVALID';
lookup(CP) when 124640 =< CP, CP =< 124661 -> 'PVALID';
lookup(CP) when 124662 =< CP, CP =< 124669 -> 'UNASSIGNED';
lookup(CP) when 124670 =< CP, CP =< 124671 -> 'PVALID';
lookup(CP) when 124672 =< CP, CP =< 124895 -> 'UNASSIGNED';
lookup(CP) when 124896 =< CP, CP =< 124902 -> 'PVALID';
lookup(CP) when 124904 =< CP, CP =< 124907 -> 'PVALID';
lookup(CP) when 124909 =< CP, CP =< 124910 -> 'PVALID';
lookup(CP) when 124912 =< CP, CP =< 124926 -> 'PVALID';
...
lookup(CP) when 127744 =< CP, CP =< 128728 -> 'DISALLOWED';
lookup(CP) when 128729 =< CP, CP =< 128731 -> 'UNASSIGNED';
lookup(CP) when 128732 =< CP, CP =< 128748 -> 'DISALLOWED';
...
lookup(CP) when 128768 =< CP, CP =< 128985 -> 'DISALLOWED';
lookup(CP) when 128986 =< CP, CP =< 128991 -> 'UNASSIGNED';
lookup(CP) when 128992 =< CP, CP =< 129003 -> 'DISALLOWED';
lookup(CP) when 129004 =< CP, CP =< 129007 -> 'UNASSIGNED';
lookup(CP) when 129009 =< CP, CP =< 129023 -> 'UNASSIGNED';
...
lookup(CP) when 129200 =< CP, CP =< 129211 -> 'DISALLOWED';
lookup(CP) when 129212 =< CP, CP =< 129215 -> 'UNASSIGNED';
lookup(CP) when 129216 =< CP, CP =< 129217 -> 'DISALLOWED';
lookup(CP) when 129218 =< CP, CP =< 129231 -> 'UNASSIGNED';
lookup(CP) when 129232 =< CP, CP =< 129240 -> 'DISALLOWED';
lookup(CP) when 129241 =< CP, CP =< 129279 -> 'UNASSIGNED';
lookup(CP) when 129280 =< CP, CP =< 129623 -> 'DISALLOWED';
lookup(CP) when 129624 =< CP, CP =< 129631 -> 'UNASSIGNED';
lookup(CP) when 129632 =< CP, CP =< 129645 -> 'DISALLOWED';
lookup(CP) when 129646 =< CP, CP =< 129647 -> 'UNASSIGNED';
lookup(CP) when 129648 =< CP, CP =< 129660 -> 'DISALLOWED';
lookup(CP) when 129661 =< CP, CP =< 129663 -> 'UNASSIGNED';
lookup(CP) when 129664 =< CP, CP =< 129674 -> 'DISALLOWED';
lookup(CP) when 129675 =< CP, CP =< 129677 -> 'UNASSIGNED';
lookup(CP) when 129678 =< CP, CP =< 129734 -> 'DISALLOWED';
lookup(CP) when 129737 =< CP, CP =< 129740 -> 'UNASSIGNED';
lookup(CP) when 129741 =< CP, CP =< 129756 -> 'DISALLOWED';
lookup(CP) when 129757 =< CP, CP =< 129758 -> 'UNASSIGNED';
lookup(CP) when 129759 =< CP, CP =< 129770 -> 'DISALLOWED';
lookup(CP) when 129771 =< CP, CP =< 129774 -> 'UNASSIGNED';
lookup(CP) when 129775 =< CP, CP =< 129784 -> 'DISALLOWED';
lookup(CP) when 129785 =< CP, CP =< 129791 -> 'UNASSIGNED';
lookup(CP) when 129792 =< CP, CP =< 129938 -> 'DISALLOWED';
lookup(CP) when 129940 =< CP, CP =< 130042 -> 'DISALLOWED';
lookup(CP) when 130043 =< CP, CP =< 131069 -> 'UNASSIGNED';
lookup(CP) when 131070 =< CP, CP =< 131071 -> 'DISALLOWED';
lookup(CP) when 131072 =< CP, CP =< 173791 -> 'PVALID';
lookup(CP) when 173792 =< CP, CP =< 173823 -> 'UNASSIGNED';
lookup(CP) when 173824 =< CP, CP =< 178205 -> 'PVALID';
lookup(CP) when 178206 =< CP, CP =< 178207 -> 'UNASSIGNED';
lookup(CP) when 178208 =< CP, CP =< 183981 -> 'PVALID';
lookup(CP) when 183982 =< CP, CP =< 183983 -> 'UNASSIGNED';
lookup(CP) when 183984 =< CP, CP =< 191456 -> 'PVALID';
lookup(CP) when 191457 =< CP, CP =< 191471 -> 'UNASSIGNED';
lookup(CP) when 191472 =< CP, CP =< 192093 -> 'PVALID';
lookup(CP) when 192094 =< CP, CP =< 194559 -> 'UNASSIGNED';
...
lookup(CP) when 201547 =< CP, CP =< 201551 -> 'UNASSIGNED';
lookup(CP) when 201552 =< CP, CP =< 210041 -> 'PVALID';
lookup(CP) when 210042 =< CP, CP =< 262141 -> 'UNASSIGNED';
