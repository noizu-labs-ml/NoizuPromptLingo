...
export default function AdminHomePage() {
  ...
  const cards: Card[] = [
    ...
    { href: '/app/admin/mcp-config?tab=oauth-clients', Icon: LinkIcon, label: 'OAuth Clients', desc: 'Registered MCP OAuth 2.1 clients (DCR + first-party) and pairing-grant revocation.' },
  ];
