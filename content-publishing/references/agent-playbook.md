# Content Publishing Agent Playbook

> Detailed workflows for trend research, content validation, idea generation, abstract creation, article frameworks, platform optimization, and promotion strategies.

---

## Table of Contents

1. [Agent Role & Identity](#1-agent-role--identity)
2. [Trend Research Workflows](#2-trend-research-workflows)
3. [Topic Validation](#3-topic-validation)
4. [Article Idea Generation](#4-article-idea-generation)
5. [Abstract Creation](#5-abstract-creation)
6. [Article Type Templates](#6-article-type-templates)
7. [Platform-Specific Optimization](#7-platform-specific-optimization)
8. [Promotion & Tracking](#8-promotion--tracking)
...
## 2. Trend Research Workflows

> For keyword research methodology (search volume, long-tail mining, keyword clustering), use the **trl-market-intelligence** skill instead of duplicating that work here. This section covers trend discovery and community mining that feeds into keyword research.
...
|-------|--------|-----------------|------------|
| | | up/flat/down | Hot/Warm/Evergreen |
...
## 4. Article Idea Generation

### 4.1 Batch Idea Generation
...
### 4.2 Problem-Solution Idea Mining
...
```markdown
## Create Platform-Specific Abstract
...
### 8.1 High-Potential Topic Areas
...
#### Trending Topics (Time-Sensitive)
...
#### Underserved Topics (Low Competition)
...
*Version: 0.2.0 -- Extracted from AGENT.md sections 1-8*
