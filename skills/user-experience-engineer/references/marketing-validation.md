# Marketing & Validation Specialist

> Principles, heuristics, and workflows for rapid idea validation through marketing assets. Gauge market demand via conversion metrics before building the actual product.

---

## Which Validation Guide Do You Need?

```
Do you need a quick gut-check (1-2 weeks, lean budget)?
  |
  YES --> Use the Validation Sprint instead:
  |       references/process/validation-sprint.md
  |       (Structured 14-day sprint, minimal budget, go/no-go decision)
  |
  NO --> Stay here.
         This file is the COMPREHENSIVE version:
         - Full persona development
         - Multi-channel ad testing
         - Landing page architecture
         - Pricing signal analysis
         - Detailed measurement frameworks

         Best when: You have 3-5 weeks, budget for ads,
         and want rigorous data before a major investment.
```
...
- [2. From Pitch to Personas](#2-from-pitch-to-personas)
  - [2.1 Pitch Extraction Framework](#21-pitch-extraction-framework)
  - [2.2 Persona Generation](#22-persona-generation)
  - [2.3 Persona Prioritization](#23-persona-prioritization)
- [3. Positioning Strategy](#3-positioning-strategy)
  - [3.1 Strategy Archetypes](#31-strategy-archetypes)
  - [3.2 Strategy Selection Heuristics](#32-strategy-selection-heuristics)
  - [3.3 Multi-Strategy Testing](#33-multi-strategy-testing)
- [4. Domain & Brand Elements](#4-domain--brand-elements)
  - [4.1 Domain Selection Criteria](#41-domain-selection-criteria)
  - [4.2 Tagline Generation](#42-tagline-generation)
  - [4.3 Copy Bank](#43-copy-bank)
- [5. Channel Strategy](#5-channel-strategy)
  - [5.1 Channel-Product Fit Matrix](#51-channel-product-fit-matrix)
  - [5.2 Channel Selection by Persona](#52-channel-selection-by-persona)
  - [5.3 Budget Allocation for Validation](#53-budget-allocation-for-validation)
- [6. Image & Visual Asset Quality](#6-image--visual-asset-quality)
  - [6.1 Principles of Compelling Images](#61-principles-of-compelling-images)
  - [6.2 Platform-Specific Image Requirements](#62-platform-specific-image-requirements)
  - [6.3 Image Quality Assessment Rubric](#63-image-quality-assessment-rubric)
  - [6.4 Stock Image Sources](#64-stock-image-sources)
- [7. Landing Page Architecture](#7-landing-page-architecture)
  - [7.1 Validation Landing Page Structure](#71-validation-landing-page-structure)
  - [7.2 Landing Page Types by Validation Goal](#72-landing-page-types-by-validation-goal)
  - [7.3 Platform-Specific Landing Pages](#73-platform-specific-landing-pages)
  - [7.4 Conversion Elements](#74-conversion-elements)
- [8. Ad Creative Guidelines](#8-ad-creative-guidelines)
  - [8.1 Ad Copy Frameworks](#81-ad-copy-frameworks)
  - [8.2 Ad Format Best Practices](#82-ad-format-best-practices)
  - [8.3 Creative Testing Matrix](#83-creative-testing-matrix)
- [9. Pricing & Offer Strategy for Validation](#9-pricing--offer-strategy-for-validation)
  - [9.1 Pre-Product Pricing Signals](#91-pre-product-pricing-signals)
  - [9.2 Offer Laddering](#92-offer-laddering)
- [10. Measurement & Signal Interpretation](#10-measurement--signal-interpretation)
  - [10.1 Key Validation Metrics](#101-key-validation-metrics)
  - [10.2 Signal vs. Noise](#102-signal-vs-noise)
  - [10.3 Decision Framework](#103-decision-framework)
- [11. Workflow Integration](#11-workflow-integration)
  - [11.1 Validation Sprint Structure](#111-validation-sprint-structure)
  - [11.2 Handoff to UX/UI Agent](#112-handoff-to-uxui-agent)
- [12. Asset Generation Outputs](#12-asset-generation-outputs)
...
┌───────┬───────┬───────┐
│       │       │       │
│   x   │       │   x   │  <- Place focal points at intersections
│       │       │       │
├───────┼───────┼───────┤
│       │       │       │
│       │       │       │
...
- Portrait (4:5): 1080x1350px -- Best for engagement
...
**Feed posts:**
- Recommended: 1200x630px (1.91:1)
- Square: 1200x1200px works well
...
> **Structured eval:** For automated generation pipelines, use the **asset prompt payload** schema which encodes these criteria as machine-readable YAML with weighted scores, fail signals, and hard-reject rules. See [`skills/shared/asset-prompt-payload-schema.md`](../../../shared/asset-prompt-payload-schema.md). The criteria above map to the `eval.criteria` block in the payload schema.
...
- `core-philosophy.md` - Foundational design principles
- `wireframes.md` - Text-based wireframe format specifications
- `styles/` - Visual style selection
- `patterns/` - Conversion patterns
- `outputs/` - Implementation specifics
- `eval/` - Measurement frameworks

---

*Version: 0.1.0-adapted*
*Adapted from: skills/user-experience-engineer/MARKETING.md*
