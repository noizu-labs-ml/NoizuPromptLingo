...
- [1. Why SVG for Mockups](#1-why-svg-for-mockups)
- [2. SVG Mockup Structure](#2-svg-mockup-structure)
  - [2.1 Basic Template](#21-basic-template)
  - [2.2 Grayscale Template (Structural)](#22-grayscale-template-structural)
...
- [5. Annotation System](#5-annotation-system)
  - [5.1 Comment Convention](#51-comment-convention)
  - [5.2 Visual Annotations](#52-visual-annotations)
- [6. Export & Delivery](#6-export--delivery)
  - [6.1 Optimization](#61-optimization)
  - [6.2 PNG Export](#62-png-export)
  - [6.3 Embedding in Documentation](#63-embedding-in-documentation)
