...
In the styleguide-engine, the branding section renders StyleCard and ProductBranding at the top, before any numbered sections. **Engine facet:** `branding.yaml` + `style-guide.meta.yaml`.
