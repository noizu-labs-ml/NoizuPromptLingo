...
- **Best for:** Financial services, Healthcare, Legal/compliance, Government/institutional, B2B enterprise software
- **Key characteristics:** Conservative typography (often serif for headings), Blue-dominant palettes (trust signaling), Clear hierarchy and navigation, Dense but organized information, Trust badges and certifications prominent, Formal tone in microcopy
- **Avoid when:** Target audience is young/casual, Brand wants to disrupt industry norms, Product is consumer-focused
...
- [6. Trust Elements](#6-trust-elements)
- [7. Interaction Patterns](#7-interaction-patterns)
- [8. Content Patterns](#8-content-patterns)
