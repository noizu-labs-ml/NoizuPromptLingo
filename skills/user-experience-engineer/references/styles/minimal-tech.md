...
- **Best for:** AI/ML products, Developer tools, B2B SaaS, Fintech, Products seeking VC funding
- **Key characteristics:** Single typeface (often geometric sans-serif), 2-3 color palette maximum (often monochrome + one accent), Generous whitespace as structural element, Subtle or no borders, Data visualization as decoration, Restrained interaction feedback
- **Avoid when:** Target audience is non-technical, Brand needs to feel warm/approachable, Product is playful or entertainment-focused
...
- [9. Reference Sites](#9-reference-sites)
