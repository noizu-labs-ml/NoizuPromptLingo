...
- [1. Layout Fundamentals](#1-layout-fundamentals)
- [2. Grid Systems](#2-grid-systems)
- [3. Bento Grid](#3-bento-grid)
- [4. Asymmetric Layouts](#4-asymmetric-layouts)
- [5. Scroll-Based Layouts](#5-scroll-based-layouts)
- [6. Dashboard Layouts](#6-dashboard-layouts)
- [7. Single Column / Editorial](#7-single-column--editorial)
- [8. Container Queries (2026 Standard)](#8-container-queries-2026-standard)
- [9. Layout Anti-Patterns](#9-layout-anti-patterns)
...
> For the design theory that explains *why* grids, white space, balance, and visual
> hierarchy work — Gestalt grouping, spatial structure (division/void/balance), and
> attentional flow patterns — see [visual-design-principles.md](../visual-design-principles.md).
...
|------|-----------|--------------|---------|
| 1x1 | 1 col, 1 row | 1:1 | Standard items |
| 2x1 | 2 col, 1 row | 2:1 | Wide feature |
| 1x2 | 1 col, 2 row | 1:2 | Tall feature |
| 2x2 | 2 col, 2 row | 1:1 | Hero/primary |
| 3x1 | 3 col, 1 row | 3:1 | Banner |
| 3x2 | 3 col, 2 row | 3:2 | Large feature |
...
|-----------|------------------------|
| 1x1 | Icon + label, stat, small image |
| 2x1 | Short text + icon, wide image, feature highlight |
| 1x2 | Vertical list, tall image, stacked stats |
| 2x2 | Hero image, video, primary CTA, key message |
...
| Metrics row | 4 across | 2x2 grid | 2x2 or stack |
