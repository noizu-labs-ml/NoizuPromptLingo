  ...
  return (
    <>
      <span className="relative inline-block">
        ...
        />
        <span className="absolute top-0 right-0 block size-1.5 rounded-full bg-gray-300 ring-2 ring-white dark:bg-gray-500 dark:ring-gray-900" />
      </span>
      ...
      <span className="relative inline-block">
        ...
        />
        <span className="absolute top-0 right-0 block size-2 rounded-full bg-red-400 ring-2 ring-white dark:bg-red-500 dark:ring-gray-900" />
      </span>
      ...
      <span className="relative inline-block">
        ...
        />
        <span className="absolute top-0 right-0 block size-2.5 rounded-full bg-green-400 ring-2 ring-white dark:bg-green-500 dark:ring-gray-900" />
      </span>
      ...
      <span className="relative inline-block">
        ...
        />
        <span className="absolute top-0 right-0 block size-3 rounded-full bg-gray-300 ring-2 ring-white dark:bg-gray-500 dark:ring-gray-900" />
      </span>
      ...
      <span className="relative inline-block">
        ...
        />
        <span className="absolute top-0 right-0 block size-3.5 rounded-full bg-red-400 ring-2 ring-white dark:bg-red-500 dark:ring-gray-900" />
      </span>
