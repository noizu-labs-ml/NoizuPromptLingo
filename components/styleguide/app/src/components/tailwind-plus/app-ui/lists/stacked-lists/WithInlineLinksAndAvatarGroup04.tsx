            ...
            <div className="flex w-16 gap-x-2.5">
              <dt>
                ...
                {discussion.status === 'resolved' ? (
                  <CheckCircleIcon aria-hidden="true" className="size-6 text-gray-400 dark:text-gray-500" />
                ) : (
                  <ChatBubbleLeftIcon aria-hidden="true" className="size-6 text-gray-400 dark:text-gray-500" />
                )}
              </dt>
              <dd className="text-sm/6 text-gray-900 dark:text-white">{discussion.totalComments}</dd>
            </div>
          </dl>
        </li>
      ))}
