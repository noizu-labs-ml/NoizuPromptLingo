...
const products = [
  ...
  },
  {
    ...
    color: 'Peach',
    size: 'S',
    imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/confirmation-page-06-product-02.jpg',
    imageAlt: "Model wearing women's artwork tee with isometric dots forming a cube in small.",
  },
]
