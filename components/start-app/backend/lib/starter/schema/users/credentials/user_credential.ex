defmodule Starter.Schema.Users.Credentials.UserCredential do
  use Ecto.Schema
  ...
  schema "user_credentials" do
    ...
    belongs_to :auth_provider, Starter.Schema.Auth.Providers.Provider, type: Ecto.UUID
    belongs_to :description, Starter.Schema.Versioned.Descriptions.Description, type: Ecto.UUID
