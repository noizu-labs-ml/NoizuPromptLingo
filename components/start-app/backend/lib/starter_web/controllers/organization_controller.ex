defmodule StarterWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case Starter.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%Starter.Users.Sessions.UserSession{} = session) do
