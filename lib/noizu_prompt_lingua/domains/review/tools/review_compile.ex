defmodule NoizuPromptLingua.Domains.Review.Tools.ReviewCompile do
  use Noizu.MCP.Server.Tool,
    name: "Review.Compile", description: "Generate annotated artifact with inline comments.", hidden: true, category: "Review"
  ...
  def call(args, _ctx) do
    ...
    {:ok, %{review_id: review_id, format: format, status: "stub", hint: "Compilation not yet implemented."}}
  end
end
