defmodule NoizuPromptLingua.Domains.Chat.Tools.AddMember do
  use Noizu.MCP.Server.Tool,
    name: "Chat.AddMember", description: "Add a persona to a room.", hidden: true, category: "Chat"
  ...
  def call(args, _ctx) do
    attrs = %{room_id: args[:room_id] || args["room_id"], persona: args[:persona] || args["persona"], role: args[:role] || args["role"] || "member"}
