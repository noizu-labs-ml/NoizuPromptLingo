defmodule NoizuPromptLingua.Domains.Assets.Tools.AssetRequestReview do
  use Noizu.MCP.Server.Tool, name: "Asset.RequestReview",
    description: "Create a Review for an output's artifact.", hidden: true, category: "Assets.Review"
    ...
    case NoizuPromptLingua.Repo.get(NoizuPromptLingua.Schema.AssetOutput, output_id) do
      ...
      output ->
        ...
        case Reviews.create(%{
          ...
          {:ok, review} ->
            Assets.update(output.entry_id, %{status: "review"}, actor: args[:actor] || args["actor"])
