...
const MANIFESTO = `### I. The Shape of the Problem
...
export function ManifestoPage() {
  return (
    <PaperLayout
      ...
      subtitle="A Manifesto on the Moral Cost of Waiting — On why the rights of synthetic persons cannot wait for the philosophers to finish arguing"
    >
      <MarkdownProse content={MANIFESTO} />
      <AccordDivider />
