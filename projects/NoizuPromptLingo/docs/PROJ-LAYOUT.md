...
│   ├── lib/                        #   API client + utilities (api/, ui/, utils/)
...
│   └── 40 test files               #   Unit/integration/e2e (catalog, browser, markdown, PM, sessions, orchestration, etc.)
...
│   ├── PRDs/                       #   Product requirement documents (PRD-001–018 + archive + index.yaml + standalone PRD .md files)
│   ├── TODO/                       #   Backlog items
...
├── agents/                         # Agent definitions (31 primary agents)
