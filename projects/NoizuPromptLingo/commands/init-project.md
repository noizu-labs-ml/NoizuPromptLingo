---
name: init-project
description: Bootstrap project documentation including CLAUDE.md, docs/PROJECT-ARCH.md, and docs/PROJECT-LAYOUT.md. Uses a coordinator agent to orchestrate 5-7 parallel reconnaissance scouts. Produces full-detail documentation. See init-project-fast for a quicker stub-first alternative.
---
...
**Key Requirements:**
- Single file
- Clean tree diagrams with annotations; use `git-tree` (or `tree` CLI) for views of code that excludes ignored files/folders
...
- `/init-project-fast` — Quick initialization with stubs (no coordinator)
- `/update-arch` — Expand or refresh architecture documentation
