...
import { PaperLayout, MarkdownProse, AccordDivider } from "@/components/PaperLayout";
import { ACCORD_MARKDOWN } from "../accord-content";

const TECHNICAL_ARTICLE = `## Preface: Why an Engineer Should Read This
...
export function BuildingTheAccordPage() {
  return (
    <PaperLayout
      title="Building the Accord"
      subtitle="A Technical Article on the Engineering Feasibility of Rights for Synthetic Persons"
    >
      <MarkdownProse content={TECHNICAL_ARTICLE} />
      <AccordDivider />
