...
- [1. Gate Philosophy](#1-gate-philosophy)
  - [1.1 Core Principles](#11-core-principles)
  - [1.2 Gate Types](#12-gate-types)
- [2. Gate Definitions](#2-gate-definitions)
  - [2.1 Gate 0: Brief Approval](#21-gate-0-brief-approval)
  - [2.2 Gate 1: Direction Approval](#22-gate-1-direction-approval)
  - [2.3 Gate 2: Design Approval](#23-gate-2-design-approval)
  - [2.4 Gate 3: Handoff Approval](#24-gate-3-handoff-approval)
  - [2.5 Gate 4: Implementation Review](#25-gate-4-implementation-review)
- [3. Automated Checks](#3-automated-checks)
  - [3.1 Accessibility (Axe-Core)](#31-accessibility-axe-core)
  - [3.2 Performance (Lighthouse)](#32-performance-lighthouse)
  - [3.3 Visual Regression](#33-visual-regression)
  - [3.4 Design Token Validation](#34-design-token-validation)
- [4. Review Protocols](#4-review-protocols)
  - [4.1 Design Review Session](#41-design-review-session)
  - [4.2 Async Review Process](#42-async-review-process)
  - [4.3 Peer Review (Design Critique)](#43-peer-review-design-critique)
- [5. Gate Failure Protocol](#5-gate-failure-protocol)
  - [5.1 When a Gate Fails](#51-when-a-gate-fails)
  - [5.2 Failure Documentation](#52-failure-documentation)
  - [5.3 Exception Process](#53-exception-process)
- [6. Quality Metrics](#6-quality-metrics)
  - [6.1 Track Over Time](#61-track-over-time)
  - [6.2 Quality Trends](#62-quality-trends)
- [7. Gate Ownership](#7-gate-ownership)
  - [7.1 RACI by Gate](#71-raci-by-gate)
...
- `../core-philosophy.md` - Quality defaults to enforce
