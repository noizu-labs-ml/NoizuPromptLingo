...
- [9. Component Checklist](#9-component-checklist)

---

## 1. Component Principles

> For the perceptual and interaction theory that informs component design — Gestalt
> grouping/segregation, signifiers and affordances, feedback timing, constraint
> types — see [visual-design-principles.md](../visual-design-principles.md).
