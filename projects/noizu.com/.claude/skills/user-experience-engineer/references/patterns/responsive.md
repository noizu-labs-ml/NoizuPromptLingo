...
- [2. Fluid Design](#2-fluid-design)
- [3. Container Queries](#3-container-queries)
- [4. Responsive Layout Patterns](#4-responsive-layout-patterns)
- [5. Responsive Components](#5-responsive-components)
- [6. Responsive Images](#6-responsive-images)
- [7. Touch Considerations](#7-touch-considerations)
- [8. Responsive Typography](#8-responsive-typography)
- [9. Testing Responsive Design](#9-testing-responsive-design)
- [10. Responsive Best Practices](#10-responsive-best-practices)
...
> For foundational typography principles (type scale theory, leading, optical sizing)
> that inform these responsive patterns, see [typography.md](../typography.md).
