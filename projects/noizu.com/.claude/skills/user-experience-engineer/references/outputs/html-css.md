...
- [1. When to Use Vanilla HTML/CSS](#1-when-to-use-vanilla-htmlcss)
- [2. Project Structure](#2-project-structure)
- [3. CSS Architecture](#3-css-architecture)
  - [3.1 Design Tokens](#31-design-tokens)
  - [3.2 CSS Reset](#32-css-reset)
  - [3.3 Base Styles](#33-base-styles)
...
- [5. Layout](#5-layout)
  ...
  - [5.2 Grid System](#52-grid-system)
  - [5.3 Utilities](#53-utilities)
- [6. Page Sections](#6-page-sections)
  - [6.1 Header](#61-header)
  - [6.2 Hero Section](#62-hero-section)
  - [6.3 Features Grid](#63-features-grid)
- [7. Responsive Patterns](#7-responsive-patterns)
  - [7.1 Mobile-First Media Queries](#71-mobile-first-media-queries)
  - [7.2 Container Query Support](#72-container-query-support)
- [8. Performance Tips](#8-performance-tips)
  - [8.1 Critical CSS](#81-critical-css)
  - [8.2 Image Optimization](#82-image-optimization)
