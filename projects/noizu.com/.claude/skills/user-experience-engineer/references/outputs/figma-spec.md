...
- [1. When to Use Figma Specs](#1-when-to-use-figma-specs)
- [2. Spec Document Structure](#2-spec-document-structure)
  - [2.1 Recommended Format](#21-recommended-format)
- [3. Foundation Specs](#3-foundation-specs)
  - [3.1 Color System](#31-color-system)
  - [3.2 Typography](#32-typography)
  - [3.3 Spacing System](#33-spacing-system)
  - [3.4 Grid System](#34-grid-system)
- [4. Component Specs](#4-component-specs)
  - [4.1 Button Specification](#41-button-specification)
  - [4.2 Input Field Specification](#42-input-field-specification)
  - [4.3 Card Specification](#43-card-specification)
- [5. Page Specifications](#5-page-specifications)
  - [5.1 Landing Page Spec](#51-landing-page-spec)
- [6. Interaction Specifications](#6-interaction-specifications)
  - [6.1 Animation Tokens](#61-animation-tokens)
  - [6.2 State Documentation](#62-state-documentation)
- [7. Asset Export Specifications](#7-asset-export-specifications)
  - [7.1 Image Export](#71-image-export)
  - [7.2 Figma Export Settings](#72-figma-export-settings)
