...
- [1. When to Use Textual](#1-when-to-use-textual)
  - [1.1 Best Use Cases](#11-best-use-cases)
  - [1.2 When NOT to Use](#12-when-not-to-use)
- [2. Setup](#2-setup)
  - [2.1 Installation](#21-installation)
  - [2.2 Project Structure](#22-project-structure)
- [3. Basic Application](#3-basic-application)
  - [3.1 Starter Template](#31-starter-template)
  - [3.2 Basic Styles](#32-basic-styles)
- [4. Components](#4-components)
  - [4.1 Data Table](#41-data-table)
  - [4.2 Card Component](#42-card-component)
  - [4.3 Stats Widget](#43-stats-widget)
  - [4.4 Progress Indicator](#44-progress-indicator)
- [5. Forms](#5-forms)
  - [5.1 Input Form](#51-input-form)
- [6. Screens & Navigation](#6-screens--navigation)
  - [6.1 Multiple Screens](#61-multiple-screens)
  - [6.2 Modal Dialogs](#62-modal-dialogs)
- [7. Real-Time Updates](#7-real-time-updates)
  - [7.1 Reactive Data](#71-reactive-data)
  - [7.2 Workers for Background Tasks](#72-workers-for-background-tasks)
- [8. Design Token Integration](#8-design-token-integration)
  - [8.1 Custom Theme](#81-custom-theme)
  - [8.2 Component Variants](#82-component-variants)
- [9. Testing](#9-testing)
  - [9.1 Unit Tests](#91-unit-tests)
  - [9.2 Snapshot Tests](#92-snapshot-tests)
- [10. Distribution](#10-distribution)
  - [10.1 PyPI Package](#101-pypi-package)
  - [10.2 Binary Distribution (PyInstaller)](#102-binary-distribution-pyinstaller)
