...
description: Enter Task Queue Listener Mode for a given queue ID or name. Polls for new tasks, assigns complexity, processes pending work, uploads artifacts, and manages status transitions through the pending → in_progress → review lifecycle.
---
