defmodule TheRobotWarsWeb.AuthzMembershipController do
  use TheRobotWarsWeb, :controller

  alias TheRobotWars.Authz.ScopedMemberships
  ...
  def org_members(conn, %{"org_id" => org_id}) do
    ...
    case TheRobotWars.Authz.authorize(user_id, "organization", org_id, "viewer") do
      {:ok, _} ->
  ...
  def project_members(conn, %{"project_id" => project_id}) do
    ...
    if TheRobotWars.Authz.check_permission(user_id, "project", project_id, "project:view") do
