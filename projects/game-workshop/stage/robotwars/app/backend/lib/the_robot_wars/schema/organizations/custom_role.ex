defmodule TheRobotWars.Schema.Organizations.CustomRole do
  use Ecto.Schema
  ...
  schema "custom_roles" do
    ...
    has_many :permissions, TheRobotWars.Schema.Organizations.CustomRolePermission, foreign_key: :role_id
