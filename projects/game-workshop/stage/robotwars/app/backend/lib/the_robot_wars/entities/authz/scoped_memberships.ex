defmodule TheRobotWars.Authz.ScopedMemberships do
  alias TheRobotWars.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias TheRobotWars.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in TheRobotWars.Schema.Users.User, on: u.id == sm.member_id,
