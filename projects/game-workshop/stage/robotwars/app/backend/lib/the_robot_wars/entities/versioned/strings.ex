defmodule TheRobotWars.Versioned.Strings do
  alias TheRobotWars.Versioned.Strings.String, as: Entity
  alias TheRobotWars.Schema.Versioned.Strings.String, as: Schema
  use Noizu.Repo
