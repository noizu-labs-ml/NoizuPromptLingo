defmodule TheRobotWars.Versioned.Names.Name do
  use Noizu.Entities

  @vsn 1.0
  @repo TheRobotWars.Versioned.Names
  @sref "versioned-name"
  @persistence ecto_store(TheRobotWars.Schema.Versioned.Names.Name, TheRobotWars.Repo)
