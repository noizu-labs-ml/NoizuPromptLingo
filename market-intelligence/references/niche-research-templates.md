...
> Deep research templates for audience profiling, competitive analysis, demand validation, and scoring. Use these after initial screening narrows candidates to 3-5 serious contenders.

## Table of Contents

1. [Audience Deep Dive](#audience-deep-dive)
2. [Competitive Landscape](#competitive-landscape)
3. [Demand Validation — Search Signals](#demand-validation--search-signals)
4. [Demand Validation — Community Signals](#demand-validation--community-signals)
5. [Purchase Intent Signals](#purchase-intent-signals)
6. [Scoring Rubric with Guidelines](#scoring-rubric-with-guidelines)
...
## Demand Validation — Search Signals
...
## Demand Validation — Community Signals
...
- Testimonial themes: [What benefits mentioned?]
...
- [ ] Similar products exist at $50+?
- [ ] Audience pays for tools/software?
- [ ] Time savings worth $50+?
- [ ] Professional budget available?
...
## Scoring Rubric with Guidelines
...
**Market Size (15%)**
- 10: Large market, growing rapidly
- 7: Medium market, stable growth
...
**AI/Product Fit (15%)**
- 10: Perfect for AI, 10x improvement possible
...
- 7: Good understanding, can learn quickly
...
| Score | Decision |
|-------|----------|
| 7.0+ | Pursue immediately |
| 5.0-6.9 | Build when capacity allows |
| <5.0 | Pass |
...
**By Audience:**
- Target 2-3 different professions/audiences
...
|-------|-------|-----------------|---------------------------|
| Freelance copywriters | 8.2 | Client communication | Client brief to copy system |
...
| Real estate agents | 7.5 | Listing descriptions | Listing to marketing bundle |
...
*Adapted from trl-market-intelligence niche research framework*
