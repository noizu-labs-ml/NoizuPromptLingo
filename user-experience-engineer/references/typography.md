...
> The style specs tell you WHAT fonts to use. This document tells you WHY. Foundational typographic principles that explain the reasoning behind every font choice, spacing decision, and hierarchy pattern in the six design systems.
...
The six style specs in this skill (`styles/*.md`) make specific typographic choices for specific contexts. This document explains the principles behind those choices so you can:
...
All six style specs assume Latin script. When that assumption fails, typography decisions must be revisited.
...
*Version: 0.1.0*
*Part of: skills/trl-user-experience-engineer*
