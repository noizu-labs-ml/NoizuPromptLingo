...
- [1. Landing Page Types](#1-landing-page-types)
  - [1.1 Selection Guide](#11-selection-guide)
  - [1.2 Conversion Benchmarks](#12-conversion-benchmarks)
- [2. Waitlist Landing Page](#2-waitlist-landing-page)
  - [2.1 Structure](#21-structure)
  - [2.2 Implementation](#22-implementation)
- [3. Smoke Test Page (Fake Door)](#3-smoke-test-page-fake-door)
  - [3.1 Purpose](#31-purpose)
  - [3.2 Structure](#32-structure)
  - [3.3 Fake Checkout Flow](#33-fake-checkout-flow)
- [4. Pre-order Page](#4-pre-order-page)
  - [4.1 Purpose](#41-purpose)
  - [4.2 Key Elements](#42-key-elements)
- [5. Conversion Optimization Patterns](#5-conversion-optimization-patterns)
  - [5.1 Above-Fold Checklist](#51-above-fold-checklist)
  - [5.2 CTA Button Patterns](#52-cta-button-patterns)
  - [5.3 Social Proof Counter](#53-social-proof-counter)
  - [5.4 Urgency Elements](#54-urgency-elements)
- [6. Form Patterns](#6-form-patterns)
  - [6.1 Email-Only Form](#61-email-only-form)
  - [6.2 Multi-Field Form (B2B)](#62-multi-field-form-b2b)
- [7. Analytics & Tracking](#7-analytics--tracking)
  - [7.1 Event Tracking Setup](#71-event-tracking-setup)
  - [7.2 Tracking Implementation](#72-tracking-implementation)
  - [7.3 UTM Parameter Capture](#73-utm-parameter-capture)
- [8. A/B Testing Setup](#8-ab-testing-setup)
  - [8.1 Simple Variant Testing](#81-simple-variant-testing)
- [9. Performance Optimization](#9-performance-optimization)
  - [9.1 Critical Path](#91-critical-path)
  - [9.2 Image Optimization](#92-image-optimization)
- [10. Checklist Before Launch](#10-checklist-before-launch)
...
2. Final CTA section — repeat signup ("Join the Waitlist")

```tsx
// Usage — the component lives at src/app/waitlist-form.tsx
...
The form renders as an inline email input + submit button on desktop (`flex-col sm:flex-row`), stacking vertically on mobile. Style the input, button, success state, and error state per the chosen design system — the structure is identical across all projects.
```
...
- `../marketing-validation.md` - Strategy and copy patterns
