...
In the styleguide-engine, Section 04 has the most available components. Use whichever are relevant to the design — not every system needs all of them. **Engine facets:** `style-guide.spacing.yaml` + `style-guide.page-layouts.yaml`.
