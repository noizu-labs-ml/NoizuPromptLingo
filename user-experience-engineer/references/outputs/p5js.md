...
- [1. When to Use p5.js Prototypes](#1-when-to-use-p5js-prototypes)
  - [1.1 Decision Matrix](#11-decision-matrix)
  - [1.2 Best Use Cases](#12-best-use-cases)
- [2. Setup](#2-setup)
  - [2.1 Quick Start (Browser)](#21-quick-start-browser)
  - [2.2 Starter Template](#22-starter-template)
- [3. UI Component Library](#3-ui-component-library)
  - [3.1 Basic Components](#31-basic-components)
  - [3.2 Layout Helpers](#32-layout-helpers)
- [4. Interaction Patterns](#4-interaction-patterns)
  - [4.1 Click/Tap Handling](#41-clicktap-handling)
  - [4.2 Drag Interactions](#42-drag-interactions)
  - [4.3 Swipe Gestures](#43-swipe-gestures)
- [5. Animation Patterns](#5-animation-patterns)
  - [5.1 Easing Functions](#51-easing-functions)
  - [5.2 Animation System](#52-animation-system)
  - [5.3 Page Transitions](#53-page-transitions)
- [6. Example: Onboarding Flow](#6-example-onboarding-flow)
- [7. Testing & Export](#7-testing--export)
  - [7.1 Recording Interactions](#71-recording-interactions)
  - [7.2 Screenshot Export](#72-screenshot-export)
  - [7.3 GIF Recording](#73-gif-recording)
- [8. Integration with Design System](#8-integration-with-design-system)
  - [8.1 Importing Design Tokens](#81-importing-design-tokens)
  - [8.2 Generating Production Code](#82-generating-production-code)
