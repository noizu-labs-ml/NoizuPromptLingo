...
```
Do you need comprehensive validation with full persona development,
multi-channel testing, and detailed measurement frameworks?
  |
  YES --> Use Marketing & Validation Specialist instead:
  |       references/marketing-validation.md
  |       (3-5 week process, ad budget, rigorous data collection)
  |
  NO --> Stay here.
         This file is the QUICK GUT-CHECK version:
         - 14-day structured sprint
         - Minimal budget required
         - Clear go/no-go decision at the end

         Best when: You want fast signal before committing
         significant time or money to building.
```
...
- [1. Overview](#1-overview)
  ...
  - [1.2 Sprint Structure](#12-sprint-structure)
  - [1.3 Inputs Required](#13-inputs-required)
  - [1.4 Outputs Delivered](#14-outputs-delivered)
- [2. Phase 1: Strategy (Days 1-4)](#2-phase-1-strategy-days-1-4)
  - [2.1 Day 1: Pitch Analysis](#21-day-1-pitch-analysis)
  - [2.2 Day 2: Persona Development](#22-day-2-persona-development)
  - [2.3 Day 3: Positioning Options](#23-day-3-positioning-options)
  - [2.4 Day 4: Channel Strategy](#24-day-4-channel-strategy)
- [3. Phase 2: Assets (Days 5-7)](#3-phase-2-assets-days-5-7)
  - [3.1 Day 5: Domain & Copy](#31-day-5-domain--copy)
  - [3.2 Days 6-7: Landing Page & Ads](#32-days-6-7-landing-page--ads)
- [4. Phase 3: Testing (Days 8-12)](#4-phase-3-testing-days-8-12)
  - [4.1 Day 8: Campaign Setup](#41-day-8-campaign-setup)
  - [4.2 Days 9-12: Run & Optimize](#42-days-9-12-run--optimize)
- [5. Phase 4: Decision (Days 13-14)](#5-phase-4-decision-days-13-14)
  - [5.1 Day 13: Analysis](#51-day-13-analysis)
  - [5.2 Day 14: Recommendation](#52-day-14-recommendation)
- [6. Templates & Checklists](#6-templates--checklists)
  - [6.1 Sprint Kickoff Checklist](#61-sprint-kickoff-checklist)
  - [6.2 Daily Standup Template](#62-daily-standup-template)
  - [6.3 Sprint Retrospective](#63-sprint-retrospective)
...
2. **Ad creative development**
   ...
   Per platform specifications from `../marketing-validation.md`:
...
- `../marketing-validation.md` - Detailed marketing strategy and asset creation
