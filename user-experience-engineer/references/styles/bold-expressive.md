...
- **Best for:** Creative agencies, Fashion/art, Music/entertainment, Portfolio sites, Brand launches seeking attention
- **Key characteristics:** Rule-breaking layouts, High contrast unexpected color combinations, Oversized typography, Intentional "imperfection", Experimental interactions, Strong point of view
- **Avoid when:** Usability is critical, Audience is conservative, Conversion is primary goal, Accessibility requirements are strict
