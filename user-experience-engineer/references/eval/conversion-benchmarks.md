...
- [1. Understanding Conversion Metrics](#1-understanding-conversion-metrics)
- [2. Landing Page Benchmarks](#2-landing-page-benchmarks)
- [3. Form Benchmarks](#3-form-benchmarks)
- [4. CTA Benchmarks](#4-cta-benchmarks)
- [5. Page Performance Benchmarks](#5-page-performance-benchmarks)
- [6. Trust & Social Proof Benchmarks](#6-trust--social-proof-benchmarks)
- [7. A/B Testing Benchmarks](#7-ab-testing-benchmarks)
- [8. Validation-Specific Benchmarks](#8-validation-specific-benchmarks)
- [9. Benchmarking Checklist](#9-benchmarking-checklist)
- [10. Benchmark Sources](#10-benchmark-sources)
...
| INP (Interaction to Next Paint) | >500ms | 200-500ms | <200ms |
...
- `../marketing-validation.md` - Validation strategy
