...
> Specifies the text-based wireframe formats available for rapid UI mockup generation. These formats are **LLM-native**: minimal tokens, version-control friendly, and directly generatable from natural language prompts.
...
- [1. Overview](#1-overview)
  - [1.1 Format Selection Matrix](#11-format-selection-matrix)
  - [1.2 When to Use Each](#12-when-to-use-each)
- [2. ASCII Wireframes](#2-ascii-wireframes)
  - [2.1 Character Set](#21-character-set)
  - [2.2 Layout Patterns](#22-layout-patterns)
  - [2.3 Complete Page Example](#23-complete-page-example)
  - [2.4 ASCII Best Practices](#24-ascii-best-practices)
  - [2.5 Tools](#25-tools)
- [3. PlantUML Salt](#3-plantuml-salt)
  - [3.1 Basic Syntax](#31-basic-syntax)
  - [3.2 Component Reference](#32-component-reference)
  - [3.3 Layout Patterns](#33-layout-patterns)
  - [3.4 Complete Page Example](#34-complete-page-example)
  - [3.5 Advanced Features](#35-advanced-features)
  - [3.6 Tools & Rendering](#36-tools--rendering)
- [4. Wireweave DSL](#4-wireweave-dsl)
  - [4.1 Basic Structure](#41-basic-structure)
  - [4.2 Layout Containers](#42-layout-containers)
  - [4.3 Component Reference](#43-component-reference)
  - [4.4 Styling Properties](#44-styling-properties)
  - [4.5 Complete Page Example](#45-complete-page-example)
  - [4.6 Tools & Integration](#46-tools--integration)
- [5. Mermaid (Flows & Architecture)](#5-mermaid-flows--architecture)
  - [5.1 User Flow Diagrams](#51-user-flow-diagrams)
  - [5.2 State Diagrams](#52-state-diagrams)
  - [5.3 Site Maps](#53-site-maps)
  - [5.4 Sequence Diagrams](#54-sequence-diagrams)
- [6. Conversion Between Formats](#6-conversion-between-formats)
- [7. Integration with Design Workflow](#7-integration-with-design-workflow)
  - [7.1 Recommended Progression](#71-recommended-progression)
  - [7.2 Version Control Strategy](#72-version-control-strategy)
  - [7.3 Token Budget Comparison](#73-token-budget-comparison)
...
- **Consume minimal tokens** - ASCII uses ~10x fewer tokens than HTML prototypes
...
*Adapted from: skills/user-experience-engineer/WIREFRAMES.md*
