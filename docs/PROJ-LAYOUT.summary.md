...
├── tests/                  # 42 test files incl. conftest.py (shared fixtures)
├── docs/                   # Architecture, reference, layout, schema, agents, claude, testing, pending, prior-version
├── project-management/     # Personas, 151 user stories, PRDs (001–018 + archive), TODOs + summary docs
...
├── agents/                 # Agent definitions (30+ primary agents + additional-agents/ + skeleton/)
