...
> **Warning:** For trust & safety and security:
>
...
2. **Number Schema**
   ...
   Note: `"integer"` type is also supported.
...
> **Note:** URL mode elicitation is introduced in the `2025-11-25` version of the MCP specification. Its design and implementation may change in future protocol revisions.
...
> **Note:** The examples in this section are non-normative and illustrate potential uses
...
> **Note:** For additional background, refer to the [token passthrough
