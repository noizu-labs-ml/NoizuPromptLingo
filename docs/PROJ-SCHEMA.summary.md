...
**Database**: PostgreSQL @ `localhost:5111/npl` | **10 tables** | **1 enum** | **15 changesets** (across 6 files)
...
- **Vector search**: npl_component, npl_sections, npl_concepts have `vector(1536)` columns with ivfflat indexes
