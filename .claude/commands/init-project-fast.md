---
name: init-project-fast
description: Bootstrap project documentation with progressive artifact generation and interstitial working files. Outputs CLAUDE.md, docs/PROJECT-ARCH.md, docs/PROJECT-LAYOUT.md. Faster than init-project — uses 4 scouts, no pre-scan coordinator, and triggers synthesis after 2 scouts complete.
---
...
Target: **150-250 lines** (vs. full init's 1200-2000)
...
Generate per standard spec — this document is naturally fast since it's structure-focused. Use `git-tree` (or `tree` CLI) for clean tree views.
...
- `/init-project` — Full initialization with coordinator
