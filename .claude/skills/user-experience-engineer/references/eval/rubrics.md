...
- [1. How to Use Rubrics](#1-how-to-use-rubrics)
- [2. Visual Design Rubric](#2-visual-design-rubric)
- [3. UX Design Rubric](#3-ux-design-rubric)
- [4. Landing Page Rubric](#4-landing-page-rubric)
- [5. Component Library Rubric](#5-component-library-rubric)
- [6. Calibration Guidelines](#6-calibration-guidelines)
- [7. Evaluation Templates](#7-evaluation-templates)
...
> For the theoretical foundations behind these criteria — why visual hierarchy works
> (attentional dominance/flow/layering), why consistency matters (systemic coherence),
> and how meaning operates (denotation/connotation/convention) — see
> [visual-design-principles.md](../visual-design-principles.md).
