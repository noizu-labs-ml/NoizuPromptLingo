...
- **Best for:** Consumer apps, E-commerce (lifestyle products), Social platforms, Food/beverage, Entertainment
- **Key characteristics:** Rounded shapes and corners, Vibrant warm color palettes, Playful illustrations or photography, Bento grid layouts, Micro-animations on interaction, Casual conversational copy
- **Avoid when:** Product handles sensitive data, Audience expects professionalism, Complex/high-stakes decisions involved
...
- [8. Conversion Patterns](#8-conversion-patterns)
