...
> For choosing your first stream, see **monetization-strategy**. This skill assumes you've already decided to build and want to plan execution.
...
| Effort | 4-6 hrs/week |
| Y1 target | $5,000/month |
| Best for | Technical expertise, prompt engineering, automation |

> For execution details, see the **ai-templates** skill.
...
| Y1 target | $2,500/month |
| Best for | Writing ability, teaching, authority building |

> For execution details, see the **content-publishing** skill.
...
| Y1 target | $1,000/month |
| Best for | Creative/design skills, niche audience understanding |

> For execution details, see the **print-on-demand** skill.
...
- **monetization-strategy** — Decide which stream to start with (run before this skill)
- **market-intelligence** — Identify and validate niches before building
- **ai-templates** — Execute AI template products
- **content-publishing** — Execute content publishing strategy
- **print-on-demand** — Execute print on demand products
- **user-experience-engineer** — Design landing pages, mockups, and brand identity

## Bundled Resources

### References
- [portfolio-strategy.md](references/portfolio-strategy.md) — Platform comparisons, weekly cadence templates, monthly review framework, scaling path, and agent invocation patterns. Read when planning multi-stream execution or reviewing portfolio performance.
