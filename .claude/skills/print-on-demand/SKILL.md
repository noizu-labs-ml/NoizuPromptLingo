...
description: >
  Used when user wnats to Design and sell niche merchandise through print-on-demand fulfillment partners
...
> For niche audience research, see the **market-intelligence** skill. For choosing POD vs. other revenue streams, see **monetization-strategy**.
...
- Built-in marketplace with 1B+ searches/month
- Upload design, Redbubble handles everything
- 20-50% margin depending on markup
...
**Pricing Strategy:**
- Redbubble markup: 20-50% above base cost (built-in audience)
...
| Skill | Relationship |
|-------|-------------|
| **conversion-engineer** | Parent coordinator for multi-stream portfolio |
| **market-intelligence** | Niche research, audience profiling, competition analysis |
| **monetization-strategy** | Stream selection, revenue model comparison |
| **ai-templates** | Cross-promotion: template buyers = merch audience |
| **content-publishing** | Cross-promotion: newsletter readers = merch buyers |
| **user-experience-engineer** | Store UX, product page optimization |
