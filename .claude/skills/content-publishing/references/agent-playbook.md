...
> For keyword research methodology (search volume, long-tail mining, keyword clustering), use the **market-intelligence** skill instead of duplicating that work here. This section covers trend discovery and community mining that feeds into keyword research.
