defmodule TheRobotWars.Users.Sessions do
  @moduledoc """
  Context for TheRobotWars.Users.Sessions
  """
  alias TheRobotWars.Users.Sessions.UserSession, as: Entity
  alias TheRobotWars.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: TheRobotWars.Users.Sessions.UserSession)
