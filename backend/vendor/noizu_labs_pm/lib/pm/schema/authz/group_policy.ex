defmodule Noizu.PM.Schema.Authz.GroupPolicy do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key {:id, Ecto.UUID, autogenerate: true}
  schema "group_policies" do
    belongs_to :group, Noizu.PM.Schema.Authz.Group, type: Ecto.UUID
    belongs_to :policy, Noizu.PM.Schema.Authz.Policy, type: Ecto.UUID
