defmodule Noizu.PM.Schema.Items.ItemTypeDefinition do
  use Ecto.Schema
  ...
  schema "item_type_definitions" do
    ...
    has_many :type_fields, Noizu.PM.Schema.Items.ItemTypeField,
      foreign_key: :item_type_definition_id
  ...
  def changeset(type_def, attrs) do
    ...
    |> unique_constraint(:slug, name: :idx_item_type_definitions_global_slug)
    |> unique_constraint(:slug, name: :idx_item_type_definitions_org_slug)
    |> unique_constraint(:slug, name: :idx_item_type_definitions_project_slug)
  end
