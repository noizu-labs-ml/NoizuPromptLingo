defmodule Noizu.PM.Schema.Items.ItemFieldDefinition do
  use Ecto.Schema
  ...
  schema "item_field_definitions" do
  ...
  def changeset(field_def, attrs) do
    ...
    |> unique_constraint(:slug, name: :idx_item_field_definitions_global_slug)
    |> unique_constraint(:slug, name: :idx_item_field_definitions_org_slug)
    |> unique_constraint(:slug, name: :idx_item_field_definitions_project_slug)
  end
