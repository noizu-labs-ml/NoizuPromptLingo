defmodule NoizuPromptLingua.Versioned.Names.Name do
  use Noizu.Entities

  @vsn 1.0
  @repo NoizuPromptLingua.Versioned.Names
  @sref "versioned-name"
  @persistence ecto_store(NoizuPromptLingua.Schema.Versioned.Names.Name, NoizuPromptLingua.Repo)
