defmodule NoizuPromptLingua.MCP.Sessions do
  use Noizu.MCP.Server,
    name: "tobor_sessions",
    version: "0.1.0",
    instructions: "Session management domain — create and manage work sessions that group rooms, artifacts, and tickets. Sessions belong to an organization; associating one with a project is optional."
