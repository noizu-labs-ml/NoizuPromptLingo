defmodule NoizuPromptLingua.Events do
  require Logger
  ...
  def dispatch(event_type, payload) when event_type in @type_list do
    ...
    Phoenix.PubSub.broadcast(NoizuPromptLingua.PubSub, "events", {event_type, payload})
  end
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(NoizuPromptLingua.PubSub, "events")
  end
end
