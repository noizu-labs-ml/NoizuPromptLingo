defmodule NoizuPromptLingua.Domains.Tickets.Tools.DefinitionGet do
  ...
  input do
    field :organization, :string, description: "Organization slug or UUID. Omit to resolve against global only."
    field :project, :string, description: "Project slug or UUID — resolves with project precedence."
