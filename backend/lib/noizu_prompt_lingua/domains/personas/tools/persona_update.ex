defmodule NoizuPromptLingua.Domains.Personas.Tools.PersonaUpdate do
  ...
  input_schema %{
    ...
    "properties" => %{
      ...
      "organization" => %{"type" => "string", "description" => "Organization slug or UUID (needed to resolve a slug)"},
      "name" => %{"type" => "string"},
      "role" => %{"type" => "string"},
      "bio" => %{"type" => "string"},
      "avatar" => %{"type" => "string"},
      ...
      "metadata" => %{"type" => "object", "description" => "Structured persona definition (voice signature, OCEAN personality, expertise graph, relationships); replaces the stored metadata object"}
    },
    "required" => ["persona"]
  }
