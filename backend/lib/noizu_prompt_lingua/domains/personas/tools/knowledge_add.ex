defmodule NoizuPromptLingua.Domains.Personas.Tools.KnowledgeAdd do
  use Noizu.MCP.Server.Tool, name: "Persona.Knowledge.Add",
    description: "Add a knowledge-base article to a persona.", hidden: true, category: "Personas.Knowledge"
  ...
  input do
    ...
    field :slug, :string, required: true, description: "Article slug, unique within the persona's KB"
