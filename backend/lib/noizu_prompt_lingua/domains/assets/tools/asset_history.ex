defmodule NoizuPromptLingua.Domains.Assets.Tools.AssetHistory do
  use Noizu.MCP.Server.Tool, name: "Asset.History",
    description: "View lifecycle audit log.", hidden: true, category: "Assets",
  ...
  def call(args, _ctx) do
    ...
    {:ok, %{entry_id: entry_id, events: Enum.map(history, &%{id: &1.id, action: &1.action, actor: &1.actor, details: &1.details, at: &1.inserted_at}), count: length(history)}}
  end
end
