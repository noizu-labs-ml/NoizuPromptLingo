defmodule NoizuPromptLingua.Domains.Campaigns.MCP do
  use Noizu.MCP.Server,
    ...
    version: "0.1.0",
    instructions: "Campaigns domain — marketing/SEO/PPC campaigns, ad groups, ad copy (LLM-generated), landing pages (LLM-generated), and domain names."
  ...
  tool NoizuPromptLingua.Domains.Campaigns.Tools.LandingPageCreate, category: "Campaigns.LandingPages"
  tool NoizuPromptLingua.Domains.Campaigns.Tools.LandingPageGet, category: "Campaigns.LandingPages"
  tool NoizuPromptLingua.Domains.Campaigns.Tools.LandingPageUpdate, category: "Campaigns.LandingPages"
  tool NoizuPromptLingua.Domains.Campaigns.Tools.LandingPageList, category: "Campaigns.LandingPages"
  tool NoizuPromptLingua.Domains.Campaigns.Tools.LandingPageGenerate, category: "Campaigns.LandingPages"
