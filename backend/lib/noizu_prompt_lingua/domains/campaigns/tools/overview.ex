defmodule NoizuPromptLingua.Domains.Campaigns.Tools.Overview do
  ...
  def call(args, _ctx) do
    ...
    {:ok,
     %{
       domain: "Campaigns",
       subdomain: "campaigns.tobor.locker",
       ...
       tools: %{
         ...
         ad_copy:
           ~w(AdCopy.Create AdCopy.Get AdCopy.List AdCopy.Generate AdCopy.Approve AdCopy.Reject),
         landing_pages:
           ~w(LandingPage.Create LandingPage.Get LandingPage.Update LandingPage.List LandingPage.Generate),
