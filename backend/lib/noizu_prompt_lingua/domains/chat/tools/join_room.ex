defmodule NoizuPromptLingua.Domains.Chat.Tools.JoinRoom do
  use Noizu.MCP.Server.Tool,
    name: "Chat.JoinRoom",
    description: "Join (or rejoin) a room. Returns only the recent backlog (last few minutes), not full history.",
    ...
    case Chat.join_room(room_id, persona) do
      {:ok, m} ->
        ...
        {:ok, %{
          ...
          recent_messages: Enum.map(backlog, &NoizuPromptLingua.Domains.Chat.Serialize.message/1),
