defmodule NoizuPromptLingua.Domains.Instructions.Tools.InstructionVersions do
  use Noizu.MCP.Server.Tool, name: "Instruction.Versions",
  ...
  def call(args, _ctx) do
    ...
    case instruction do
      ...
      i ->
        ...
        {:ok, %{active_version: i.active_version, count: length(versions),
          versions: Enum.map(versions, fn v ->
            %{version: v.version, change_note: v.change_note, at: v.inserted_at,
