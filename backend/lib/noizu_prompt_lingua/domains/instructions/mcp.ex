defmodule NoizuPromptLingua.Domains.Instructions.MCP do
  use Noizu.MCP.Server,
    ...
    version: "0.1.0",
    instructions: "Instruction domain — reusable versioned prompts referenced by slug handle and rendered with per-task params to spawn sub-agents."
  ...
  tool NoizuPromptLingua.Domains.Instructions.Tools.InstructionSetActiveVersion, category: "Instructions"
  tool NoizuPromptLingua.Domains.Instructions.Tools.InstructionRender, category: "Instructions.Dispatch"
