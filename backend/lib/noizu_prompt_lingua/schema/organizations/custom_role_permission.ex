defmodule NoizuPromptLingua.Schema.Organizations.CustomRolePermission do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key {:id, Ecto.UUID, autogenerate: true}
  schema "custom_role_permissions" do
    belongs_to :role, NoizuPromptLingua.Schema.Organizations.CustomRole, type: Ecto.UUID
