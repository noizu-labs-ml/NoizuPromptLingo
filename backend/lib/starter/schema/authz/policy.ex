defmodule Starter.Schema.Authz.Policy do
  use Ecto.Schema
  ...
  schema "policies" do
    ...
    belongs_to :created_by_user, Starter.Schema.Users.User, type: Ecto.UUID, foreign_key: :created_by

    has_many :group_policies, Starter.Schema.Authz.GroupPolicy
