defmodule Starter.Schema.Authz.ScopedMembership do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key {:id, Ecto.UUID, autogenerate: true}
  schema "scoped_memberships" do
    belongs_to :group, Starter.Schema.Authz.Group, type: Ecto.UUID
    field :resource_type, :string
    field :resource_id, Ecto.UUID
    field :member_type, :string
    field :member_id, Ecto.UUID
    field :expires_at, :utc_datetime_usec
    belongs_to :added_by_user, Starter.Schema.Users.User, type: Ecto.UUID, foreign_key: :added_by
